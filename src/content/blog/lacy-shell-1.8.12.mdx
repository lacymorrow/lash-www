...
description: "Lacy Shell v1.8.12 fixes bash compatibility, adds four new AI backends, and ships smarter natural language routing for terminal users."
...
## Four new backends: Aider, Amp, Goose, Copilot, plus Hermes
