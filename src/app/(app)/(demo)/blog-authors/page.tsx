    ...
    <div className="w-full max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Showcasing the new centralized author configuration system with enhanced
          components, accessibility features, and improved user experience.
        </p>
      ...
      <section className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Compact author attribution for blog post headers
          </p>
        </div>
        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              />
              <p className="text-muted-foreground">
                This is how an author byline would appear in a blog post header,
                showing the author's avatar, name, and publication date.
              </p>
            </CardContent>
          </Card>
      ...
      <section className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Show multiple authors with overlapping avatars
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Multiple authors are displayed with overlapping avatars that link
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                All author data is managed in a single configuration file with
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                ...
                compatibility throughout all components.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Automatic social media link generation with proper icons and
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                All components adapt seamlessly to different screen sizes and
                device types.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Graceful fallbacks for missing images, broken links, and
                unavailable data.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Supports legacy author data while providing migration path to
                new system.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="text-sm space-y-2">
                <p><code className="text-xs bg-muted px-1 rounded">getAuthorById()</code> - Get author by ID</p>
                <p><code className="text-xs bg-muted px-1 rounded">getAuthorByName()</code> - Get author by name</p>
                <p><code className="text-xs bg-muted px-1 rounded">convertLegacyAuthor()</code> - Convert legacy data</p>
                <p><code className="text-xs bg-muted px-1 rounded">authorUtils.getSocialLinks()</code> - Generate social links</p>
              </div>
            </CardContent>
          </Card>
        </div>
...
---`}
      ...
      <div className="text-center py-8 text-sm text-muted-foreground">
        <p>
          This demo showcases the enhanced blog author system with improved
