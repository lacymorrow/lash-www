      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Get started with the premium Next.js boilerplate that includes
            everything you need to build and ship your product fast.
          </p>
        </div>
  ...
  return (
    <Card className={cn(!isEnabled && "opacity-50")}>
      <CardHeader>
        ...
        <CardDescription>
          Download a ZIP file containing the complete {siteConfig.name}{" "}
          codebase. Perfect for getting started quickly.
        </CardDescription>
      </CardHeader>
      <CardContent>
  ...
  return (
    <Card className={cn(!isEnabled && "opacity-50")}>
      <CardHeader>
        ...
        <CardDescription>
          Connect your GitHub account to clone the repository directly and get
          automatic updates.
        </CardDescription>
      </CardHeader>
      <CardContent>
