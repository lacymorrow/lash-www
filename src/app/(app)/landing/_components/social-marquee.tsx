...
const reviews = [
  {
    ...
    company: "Vercel",
    body: `${siteConfig.title} saved us months of setup time. The authentication and API routes are production-ready out of the box.`,
    img: getAvatarUrl("Sarah Chen"),
    verified: true,
  },
  {
    name: "Alex Rivera",
  ...
  },
  {
    ...
    role: "Tech Lead",
    company: "ScaleAI",
    body: `We migrated from a custom solution to ${siteConfig.title} and immediately saw improvements in our development velocity.`,
    img: getAvatarUrl("Michael Park"),
    verified: true,
  },
  {
    name: "Emma Lewis",
