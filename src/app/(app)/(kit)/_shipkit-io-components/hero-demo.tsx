...
const tabs = [
  {
    ...
    content: {
      ...
      description:
        "Sign in with Google, GitHub, or any OAuth provider. Role-based access control built-in.",
  ...
  },
  {
    ...
    content: {
      title: "Custom GPTs",
      description:
        "Build AI features in minutes with our pre-built components and OpenAI integration.",
