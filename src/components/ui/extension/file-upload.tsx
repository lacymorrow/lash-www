  ...
  (
      ...
      (acceptedFiles: File[], rejectedFiles: FileRejection[]) => {
        ...
        if (rejectedFiles.length > 0) {
          for (let i = 0; i < rejectedFiles.length; i++) {
            const rejected = rejectedFiles[i];
    ...
    return (
      ...
      >
        <div
          ref={ref}
          // biome-ignore lint/a11y/noNoninteractiveTabindex: uploader region must be focusable so arrow-key navigation (onKeyDownCapture) works
          tabIndex={0}
