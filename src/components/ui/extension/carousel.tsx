  ...
  (
    ...
    return (
      ...
      >
        <div
          {...props}
          // biome-ignore lint/a11y/noNoninteractiveTabindex: carousel region must be focusable so arrow-key navigation (onKeyDownCapture) works
          tabIndex={0}
          ref={ref}
...
>(({ className, index, children, ...props }, ref) => {
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: forwardRef<HTMLDivElement> thumb wrapper; converting to native <button> would ripple ref/prop typing
    <div
      {...props}
      ref={ref}
      role="button"
