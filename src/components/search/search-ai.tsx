  ...
  return (
    <>
      <Button
        ...
        {...props}
        className={cn(
          "group relative w-full justify-start rounded-[0.5rem] bg-muted/50 py-0 text-sm font-normal text-muted-foreground shadow-none sm:pr-12 md:max-w-40 lg:max-w-64",
          props.className,
          "relative"
        )}
      >
        ...
        <ShortcutDisplay
          ...
          className="pointer-events-none absolute right-1 top-1/2 -translate-y-1/2 opacity-100 group-hover:flex"
        />
      </Button>
