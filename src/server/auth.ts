...
function authWithOptions(props?: AuthProps): Promise<Session | { user: null; expires: string }>;
...
// Overloads and implementation for authenticated
function authenticated(props: { protect: true } & AuthProps): Promise<ProtectedSession>;
function authenticated(props?: AuthProps): Promise<Session | { user: null; expires: string }>;
async function authenticated(props?: AuthProps) {
