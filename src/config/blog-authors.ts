...
export const blogAuthors: Record<string, BlogAuthor> = {
	...
	"lash-team": {
		...
		bio: "The team behind Lash, building open source AI tools for the terminal.",
		website: "https://lash.lacy.sh",
		twitter: "lacybuilds",
		github: "lacymorrow",
		email: "team@lash.lacy.sh",
 ...
 */
export const defaultAuthor: BlogAuthor = blogAuthors["lacy-morrow"];
