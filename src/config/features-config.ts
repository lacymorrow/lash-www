...
buildTimeFeatures.DEVTOOLS_FONT_SELECTOR_ENABLED =
...
buildTimeFeatures.AUTH_BITBUCKET_ENABLED =
  hasEnv("AUTH_BITBUCKET_ID", "AUTH_BITBUCKET_SECRET") &&
  !envIsTrue("DISABLE_AUTH_BITBUCKET");
buildTimeFeatures.AUTH_DISCORD_ENABLED =
  hasEnv("AUTH_DISCORD_ID", "AUTH_DISCORD_SECRET") &&
  !envIsTrue("DISABLE_AUTH_DISCORD");
buildTimeFeatures.AUTH_GITHUB_ENABLED =
  hasEnv("AUTH_GITHUB_ID", "AUTH_GITHUB_SECRET") &&
  !envIsTrue("DISABLE_AUTH_GITHUB");
buildTimeFeatures.AUTH_GITLAB_ENABLED =
  hasEnv("AUTH_GITLAB_ID", "AUTH_GITLAB_SECRET") &&
  !envIsTrue("DISABLE_AUTH_GITLAB");
buildTimeFeatures.AUTH_GOOGLE_ENABLED =
  hasEnv("AUTH_GOOGLE_ID", "AUTH_GOOGLE_SECRET") &&
  !envIsTrue("DISABLE_AUTH_GOOGLE");
buildTimeFeatures.AUTH_TWITTER_ENABLED =
  hasEnv("AUTH_TWITTER_ID", "AUTH_TWITTER_SECRET") &&
  !envIsTrue("DISABLE_AUTH_TWITTER");
buildTimeFeatures.AUTH_VERCEL_ENABLED =
  hasEnv("VERCEL_CLIENT_ID", "VERCEL_CLIENT_SECRET") &&
  !envIsTrue("DISABLE_AUTH_VERCEL");
...
buildTimeFeatures.OPENAI_ENABLED =
  hasEnv("OPENAI_API_KEY") && !envIsTrue("DISABLE_OPENAI");
...
buildTimeFeatures.POLAR_ENABLED =
  hasEnv("POLAR_ACCESS_TOKEN") && !envIsTrue("DISABLE_POLAR");
...
buildTimeFeatures.REDIS_ENABLED =
  hasEnv("UPSTASH_REDIS_REST_URL", "UPSTASH_REDIS_REST_TOKEN") &&
  !envIsTrue("DISABLE_REDIS");
...
buildTimeFeatures.GOOGLE_ANALYTICS_ENABLED =
  hasEnv("NEXT_PUBLIC_GOOGLE_ANALYTICS_ID") &&
  !envIsTrue("DISABLE_GOOGLE_ANALYTICS");
buildTimeFeatures.GOOGLE_TAG_MANAGER_ENABLED =
  hasEnv("NEXT_PUBLIC_GOOGLE_GTM_ID") &&
  !envIsTrue("DISABLE_GOOGLE_TAG_MANAGER");
...
if (!buildTimeFeatureFlags.NEXT_PUBLIC_FEATURE_AUTH_ENABLED) {
  buildTimeFeatureFlags.NEXT_PUBLIC_FEATURE_AUTH_ENABLED =
    buildTimeFeatures.AUTH_ENABLED ? "true" : "false";
}
