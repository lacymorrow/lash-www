...
description: "Auth.js (NextAuth.js v5) is Shipkit's default authentication library. It comes pre-configured and supports 40+ OAuth providers."
---
...
- [Main Authentication Guide](/docs/features/authentication)
