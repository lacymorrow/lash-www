...
1. **[Payload CMS](/docs/features/cms)** - A self-hosted headless CMS with a powerful admin interface
2. **[Builder.io](/docs/features/visual-builder)** - A visual page builder with a drag-and-drop interface
...
Shipkit also supports [Markdown and MDX](/docs/guides/markdown-mdx) for content authoring, which can be used alongside either CMS option.
