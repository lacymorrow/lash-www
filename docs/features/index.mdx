...
All Shipkit features are available as installable shadcn registry blocks. Start from [bones](https://github.com/shipkit-io/bones) and add features incrementally with `npx shadcn add @shipkit/<block>`. 30 blocks available covering auth, payments, blog, docs, CMS, analytics, email, admin, settings, and more.
